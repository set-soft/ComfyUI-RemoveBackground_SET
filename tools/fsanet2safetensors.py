...
#
# Tool to convert the FSANet to a safetensors file
import argparse
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FSANet to safetensors",
    ...
    name = "FSANet"
    metadata = {
        "desc": f"{name} DIS5K background remover",
        "download": f"https://huggingface.co/set-soft/RemBG/resolve/main/PGNet/FSANet_DIS5K_{fp}.safetensors",
        "original": "https://drive.google.com/file/d/1b0Dfrbxllnl0aChXH8roiDiiirnUpwjq/view?usp=sharing",
        "file_t": "safetensors",
        "model_t": "FSANet",
        "name": f"FSANet_DIS5K_{fp}",
        "size": "992",
        "normalize": "ImageNet",
        "dtype": dt,
