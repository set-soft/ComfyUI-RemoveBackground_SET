...
from .modeling_outputs import BaseOutput
from .attention import BasicTransformerBlock_mecross
...
class Transformer2DModel_mecross(nn.Module):
    """
    ...
    def __init__(
        ...
        assert caption_channels is None
