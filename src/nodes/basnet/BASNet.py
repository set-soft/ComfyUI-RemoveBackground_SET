...
# Xuebin Qin, Deng-Ping Fan, Chenyang Huang, Cyril Diagne, Zichen Zhang, Adrià Cabeza Sant'Anna, Albert Suàrez,
# Martin Jagersand, Ling Shao
#
# Paper: https://arxiv.org/abs/2101.04704
#
# Code: https://github.com/xuebinqin/BASNet
# Weights: https://huggingface.co/creative-graphic-design/BASNet-checkpoints/tree/main
# License: MIT
#
...
from ..resnet.resnet import BasicBlock, resnet34
...
class BASNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # # -------------Refine Module-------------
        d = F.sigmoid(self.refunet(self.outconv1(hd1)))  # 256
